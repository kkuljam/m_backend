...
//        System.out.println( "배열  상태 : " + Arrays.toString( strArray )  );
      ...
      /*  SimpleList<String> simpleList = new SimpleList<>();
        ...
        SimpleListA<Object, Objects> simpleList1=new SimpleListA<>();
        simpleList1.add("사과",900);
        simpleList1.add("과자","새우깡");
        simpleList1.add("과자",25);
        simpleList1.add("이름","유재석");
        System.out.println(simpleList1);
        System.out.println(simpleList1.get("과자"));
        simpleList1.remove(1);
        System.out.println(simpleList1);
        System.out.println(simpleList1.size());
