...
//        문제2 : 점수를 입력받아 점수가 90점 이상이면 'A등급', 80점 이상이면 'B등급', 70점 이상이면 'C등급', 그외 '재시험' 으로 출력 하시오.
        System.out.println("점수 :");     int 점수1 = scanner.nextInt();
        if(점수1>=90){
...
//        문제3 : 임의의 정수 3개 를 입력받아서 오름차순 으로 3개의 변수를 출력하시오.
        System.out.println("정수 1 :"); int n1 =scanner.nextInt();
        System.out.println("정수 2 :"); int n2 =scanner.nextInt();
        System.out.println("정수 3 :"); int n3 =scanner.nextInt();
        int tmep = 0;
        if(n1<n2){ tmep=n1; n1=n2; n2=tmep;}
        if(n1<n3){ tmep=n1; n1=n3; n3=tmep;}
        if(n2<n3){ tmep=n2; n2=n3; n3=tmep;}
...
/*        문제4 : 가위바위보 게임 구현하기.
     ...
     [출력 조건] 플레이어1 이기면 ' 플레이어1 승리 ', 플레이어2 이기면 ' 플레이어2 승리 ' 무승부 이면 '무승부' 출력 하시오.*/
       /* System.out.println("가위가 '0' 이고 바위가 '1' 이고 보가 '2'");
        System.out.println("플레이어 1 :"); int p1 =scanner.nextInt();
        System.out.println("플레이어 2 :"); int p2 =scanner.nextInt();
        if (p1==p2){
...
/*        String id=scanner.nextLine(); String pw=scanner.nextLine();
        if(id.equals("admin")){
            if(pw.equals("1234")){
...
//   [ 출력 조건 ] 입력받은 세 정수 중에서 공1~공3 까지 동일한 번호 가 몇개 인지 출력하시오.
   /*     int 공1 = 14 ; int 공2 = 21 ; int 공3 = 9;
        ...
        System.out.println("동일한 번호 개수는:" +result);*/
